      ...
      <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              ...
              <Nav.Link as={Link} to="/enter-vitals">Enter Vitals</Nav.Link>
              <Nav.Link as={Link} to="/nurse-page">Nurse Page</Nav.Link>
              <Nav.Link as={Link} to="/patient-page">Patient Page</Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
        </Navbar>
